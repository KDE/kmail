...
void AccountWizard::setupWelcomePage()
{
  ...
  QString helpText( i18n( "<qt>An identity is your email address, "
                                        "name, organization and so on. "
                                        "Do not uncheck this if you do not know what "
                                        "you are doing, as some servers refuse to send mail "
                                        "if the sending identity does not match the one belonging "
                                        "to that account.</qt>") );
