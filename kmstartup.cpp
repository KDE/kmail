...
void migrateConfig()
{
    ...
    migrate.setConfigFiles(QStringList() << QLatin1String("kmail2rc") << QLatin1String("kmail2.notifyrc") << QLatin1String("kmailsnippetrc") << QLatin1String("customtemplatesrc") << QLatin1String("templatesconfigurationrc") << QLatin1String("kpimcompletionorder"));
