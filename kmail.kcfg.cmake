  ...
  <kcfgfile name="kmailrc"/>
    <group name="Behaviour">
      ...
      <entry name="ExcludeImportantMailFromExpiry"  type="Bool">
        <label></label>
        <whatsthis>This prevents the automatic expiry of old messages in a folder from deleting (or moving to an archive folder) the messages that are marked 'Important' or 'Todo'</whatsthis>
        <default>true</default>
      </entry>
...
<!-- Composer -->
    ...
    <group name="Reader">
     ...
     <entry name="ForegroundColor" type="Color" key="ForegroundColor">
       <default code="true">KColorScheme( QPalette::Normal ).foreground().color()</default>
     </entry>
     <entry name="BackgroundColor" type="Color" key="BackgroundColor">
       <default code="true">KColorScheme( QPalette::Normal ).background().color()</default>
     </entry>
