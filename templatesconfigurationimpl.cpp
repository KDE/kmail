...
void TemplatesConfiguration::button_insert_clicked() {
	...
	quote_popup.insertItem(i18n("CC field last name"), COCCLName);
	quote_popup.insertItem(i18n("CC field address"), COCCAddr);
	quote_popup.insertItem(i18n("CC field name"), COCCName);
	quote_popup.insertItem(i18n("CC field first name"), COCCFName);
	quote_popup.insertItem(i18n("CC field last name"), COCCLName);
	...
	msg_popup.insertItem(i18n("CC field address"), CCCAddr);
	msg_popup.insertItem(i18n("CC field name"), CCCName);
	msg_popup.insertItem(i18n("CC field first name"), CCCFName);
	msg_popup.insertItem(i18n("CC field last name"), CCCLName);
	...
	if(index > 0) {
		switch(index) {
			...
			case COCCAddr: insertCommand("%OCCADDR"); break;
			case COCCName: insertCommand("%OCCNAME"); break;
			case COCCFName: insertCommand("%OCCFNAME"); break;
			case COCCLName: insertCommand("%OCCLNAME"); break;
			...
			case CCCAddr: insertCommand("%CCADDR"); break;
			case CCCName: insertCommand("%CCNAME"); break;
			case CCCFName: insertCommand("%CCFNAME"); break;
			case CCCLName: insertCommand("%CCLNAME"); break;
