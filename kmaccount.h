...
public:
   ...
   */
  virtual void ignoreJobsForMessage( const KMime::Message::Ptr & );
  /**
...
protected:
   ...
   */
  virtual bool processNewMsg( const KMime::Message::Ptr &msg );
   ...
   */
  virtual void sendReceipt( const KMime::Message::Ptr &msg );
...
protected:
  ...
  QList<KMime::Message::Ptr> mReceipts;
