...
static const about_data authors[] = {
    ...
    {"Cristi Dumitrescu", I18N_NOOP_EMPTY, "cristid@chip.ro", nullptr}, // No commits. One patch, Apr 5, 2001.
    {"David Faure", I18N_NOOP("Major contributor, still active"), "faure@kde.org", nullptr}, // Last Commit Oct 6, 2020. 195 commits.
    {"Philippe Fremy", I18N_NOOP_EMPTY, "pfremy@chez.com", nullptr}, // No commits. Mentioned twice in 2001.
    {"Kurt Granroth", I18N_NOOP("Added maildir support"), "granroth@kde.org", nullptr}, // Last commit Jun 26, 2002. 20 commits.
    {"Andreas Gungl",
     I18N_NOOP("PGP 6 support and further enhancements of the encryption support"),
     "a.gungl@gmx.de",
     nullptr}, // Last commit Mar 25, 2007. 247 commits.
    {"Steffen Hansen", I18N_NOOP_EMPTY, "hansen@kde.org", nullptr}, // Last commit Jun 11, 2004. 12 commits.
    {"Igor Janssen", I18N_NOOP_EMPTY, "rm@linux.ru.net", nullptr}, // One commit dated May 28, 2001.
    {"Matt Johnston", I18N_NOOP_EMPTY, "matt@caifex.org", nullptr}, // No commits. Two patches, Nov - Dec, 2000.
    {"Christer Kaivo-oja", I18N_NOOP_EMPTY, "whizkid@telia.com", nullptr}, // No commits. One patch, Mar 7,2001.
    ...
    {"Guillaume Laurent", I18N_NOOP_EMPTY, "glaurent@telegraph-road.org", nullptr}, // Last Apr 19, 2001. 2 commits, five patches.
    {"Sam Magnuson", I18N_NOOP_EMPTY, "sam@trolltech.com", nullptr}, // One commit, Mar 10, 2003. Two patches.
    {"Matt Newell", I18N_NOOP_EMPTY, "newellm@proaxis.com", nullptr}, // No commits. Three patches, the latest one dated Feb 23, 2001
    {"Denis Perchine", I18N_NOOP_EMPTY, "dyp@perchine.com", nullptr}, // Last commit Dec 22, 2000. 4 commits, 1 large patch.
    {"Samuel Penn", I18N_NOOP_EMPTY, "sam@bifrost.demon.co.uk", nullptr}, // No commits. Two patches -- most recent Jan 1, 2002.
    ...
    {"Mark Roberts", I18N_NOOP_EMPTY, "mark@taurine.demon.co.uk", nullptr}, // No commits. One patch dated Sep 19, 2000.
    {"Wolfgang Rohdewald", I18N_NOOP_EMPTY, "wolfgang@rohdewald.de", nullptr}, // One commit, Dec 10, 2008.
    ...
    {"Jason Stephenson", I18N_NOOP_EMPTY, "panda@mis.net", nullptr}, // Last commit Mar 15, 2001. 8 commits.
    {"Jacek Stolarczyk", I18N_NOOP_EMPTY, "jacek@mer.chemia.polsl.gliwice.pl", nullptr}, // Last commit Nov 9, 2000. 16 commits.
    {"Roberto S. Teixeira", I18N_NOOP_EMPTY, "maragato@kde.org", nullptr}, // Last commit Oct 23, 2003. 5 commits.
    {"Bo Thorsen", I18N_NOOP("Many valuable contributions"), "bo@sonofthor.dk", nullptr}, // Last commit Nov17, 2004. 183 commits.
    {"Ronen Tzur", I18N_NOOP_EMPTY, "rtzur@shani.net", nullptr}, // No commits. 10 patches, last one dated Jan 4, 2002.
    {"Mario Weilguni", I18N_NOOP_EMPTY, "mweilguni@sime.com", nullptr}, // Last commit May 29, 2000. 10 commits.
    {"Wynn Wilkes", I18N_NOOP_EMPTY, "wynnw@calderasystems.com", nullptr}, // One commit, Jan 11, 2002. Also one patch.
    {"Robert D. Williams", I18N_NOOP_EMPTY, "rwilliams@kde.org", nullptr}, // Last commit Jun 2, 2000. 26 commits.
...
static const about_data credits[] = {
    ...
    {"Joern Ahrens",
     I18N_NOOP("Improve 'Mark Message as' popup menu"),
    ...
    {"Pradeepto Bhattacharya",
     I18N_NOOP("LDAP support, maintenance"),
     "pradeepto@kde.org",
     nullptr}, // 294 commits. Lots of "bump version number" commits. LDAP patches
    {"Bruno Bigras", I18N_NOOP_EMPTY, "bigras.bruno@gmail.com", nullptr},
    ...
    {"Albert Astals Cid",
     I18N_NOOP("Substantial contributor, still active"),
     "aacid@kde.org",
    ...
    {"Ingo Heeskens",
     I18N_NOOP("Enable external reference loading for a whole folder"),
     "ingo@fivemile.org",
    ...
    {"Jason 'vanRijn' Kasper",
     I18N_NOOP("Choice of fonts for new/unread/important messages"),
     "vr@movingparts.net",
     nullptr}, // implemented wish 79938 (configurable font for new/unread/important messages)
    {"Martijn Klingens",
     I18N_NOOP("Fix Quick Search keyboard navigation"),
     "klingens@kde.org",
     nullptr}, // fix keyboard navigation in the Status combo of the quick search
    {"Christoph Klünter",
     I18N_NOOP("Fix drag and drop from address book to composer"),
    ...
    {"Nikolai Kosjar", I18N_NOOP_EMPTY, "nikolai.kosjar@qt.io", nullptr},
    ...
    {"Michael Leupold", I18N_NOOP_EMPTY, "lemma@confuego.org", nullptr},
    {"Thiago Macieira", I18N_NOOP_EMPTY, "thiago@kde.org", nullptr},
    {"Andras Mantia", I18N_NOOP_EMPTY, "amantia@kde.org", nullptr},
    {"Jonathan Marten", I18N_NOOP_EMPTY, "jjm@keelhaul.me.uk", nullptr},
    {"Sergio Luis Martins", I18N_NOOP_EMPTY, "iamsergio@gmail.com", nullptr},
    {"Jeffrey McGee", I18N_NOOP("Patch for window resizing problem"), "jeffreym@cs.tamu.edu", nullptr}, // fix for bug:64251
    {"Thomas Moenicke", I18N_NOOP_EMPTY, "tm@php-qt.org", nullptr},
    ...
    {"Mario Teijeiro Otero", I18N_NOOP_EMPTY, "emeteo@escomposlinux.org", nullptr}, // various vendor annotations fixes
    {"Kevin Ottens", I18N_NOOP_EMPTY, "ervin@kde.org", nullptr},
    {"Simon Perreault",
     I18N_NOOP("Patch composer configuration"),
     "nomis80@nomis80.org",
     nullptr}, // make the composer remember its "Use Fixed Font" setting (bug 49481)
    {"Jakob Petsovits", I18N_NOOP_EMPTY, "jpetso@gmx.at", nullptr},
    {"Romain Pokrzywka", I18N_NOOP_EMPTY, "romain@kdab.net", nullptr},
    {"Bernhard Reiter", I18N_NOOP("Ägypten and Kroupware project management"), "bernhard@intevation.de", nullptr},
    {"Darío Andrés Rodríguez", I18N_NOOP_EMPTY, "andresbajotierra@gmail.com", nullptr},
    ...
    {"Paul Sprakes",
     I18N_NOOP("Bug fixes, cleaned up context menus"),
