...
void SpellCheckerConfigDialog::readConfig()
{
    ...
    KConfigGroup group(KSharedConfig::openStateConfig(), QLatin1String("SpellCheckerConfigDialog"));
...
{
    KConfigGroup notifyDialog(KMKernel::self()->config(), QLatin1String("SpellCheckerConfigDialog"));
