...
void KMKnotify::readConfig()
{
    ...
    KConfigGroup group(KSharedConfig::openStateConfig(), QLatin1String("KMKnotifyDialog"));
...
{
    KConfigGroup notifyDialog(KMKernel::self()->config(), QLatin1String("KMKnotifyDialog"));
