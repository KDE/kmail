...
namespace KMail {
    ...
    : KDialog( parent )
  {
    ...
    ++row;
    mFccCombo = new FolderRequester( KMKernel::config(), tab );
    ...
    ++row;
    mDraftsCombo = new FolderRequester( KMKernel::config(), tab );
    ...
    ++row;
    mTemplatesCombo = new FolderRequester( KMKernel::config(),tab );
