  ...
  : ASWizPage( parent, name )
{
  ...
  mFolderReqForSpamFolder = new FolderRequester( KMKernel::config(), KMKernel::self()->collectionModel(), this );
  ...
  mFolderReqForUnsureFolder = new FolderRequester( KMKernel::config(), KMKernel::self()->collectionModel(), this );
